...
<h1 class="t1">AGENDA TU CITA</h1>
<h2 class="t2">!NOSOTROS TE LLAMAMOS¡</h2>
...
<form action="registrar.php" method="POST">
   ...
   Horario preferido de llamada<br>
   <select name="horario" >


   <option value="no selecciono">Seleccionar</option>
   <option value="8am a 10am">8am a 10am</option>
   <option value="2pm a 4pm">2pm a 4pm</option>
   <option value="8pm a 10pm">8pm a 10pm</option>
